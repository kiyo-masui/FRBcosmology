...
characteristic wavelength-squared delay of electromagnetic signals. The disperion is
proportional to the amount of plasma along the
line-of-sight and can thus be used to estimate radial distance.
This technique, routinely done with
...
surrounding galaxies along the line-of-sight \citep{2013Sci...341...53T}
...
Mapping Experiment (CHIME) telescope over a three year survey.
