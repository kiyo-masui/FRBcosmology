...
of radio transient first reported in \citet{2007Sci...318..777L}.
There have since been 
10 such bursts reported \citep{2012MNRAS.425L..71K,2013Sci...341...53T, 2014ApJ...790..101S, 2014ApJ...792...19B, 2015MNRAS.447..246P,2015ApJ...799L...5R} and total rate of bursts
...
used as a distance estimate, as is routinely done for galactic pulsars.
Because FRBs are observed to have dispersion measures greatly in excess of
the galactic expectation they must be of extra-galactic origin, with their
dispersion produced either by
inter-galactic medium (IGM) \citep{2013Sci...341...53T} or the
environment of the source
\citep{2014ApJ...785L..26L,2015arXiv150101341P}.
If the dispersion is dominated by the inter-galactic medium, then 
 then the average DM-distance relation can be modelled
\citep{2004MNRAS.348..999I, 2003ApJ...598L..79I} and the sources are at
cosmological distances of a few gigaparsecs. This would permit
the study of the clustering of FRBs in three dimensions which should trace the
large-scale structure of the Universe on linear scales.
...
refer to them as such for the remainder of this work.
...
that the electron bias $b_e=1$, which should be true on large scales due to
approximate conservation of free electrons. The bias of FRB sources is
...
a radial distance of $\chi=2350\,{\rm MPc}/h$ are at the detection threshold.
...
\begin{figure}
    ...
    \caption{
        ...
        such that the survey has a total of $10^4$ FRBs.
...
I can be seen in Figure~\ref{f:terms} that the integral term dominates the
cross term and the local term except at small radial separations.  We've found
that this is generically true for most $(\chi, \chi')$ pairs and that the
sensitivity shown in Figure~\ref{f:sensitivity} is dominated by the integral
term. Since the integral term only depends on the clustering of electrons, not
sources, an FRB survey could be used to study the distribution of electrons and
potentially solve the `missing baryon problem' as pointed out in
\citet{2014ApJ...780L..33M}.

We have calculated the clustering of sources in dispersion measure space and
shown that a survey detecting a modest $10^4$ fast radio bursts of cosmological
origin could detect the clustering signal.
...
local-term curves. It might even be possible to extract it from the integral
term using tomography.
This however depends on the contribution to dispersion measure from
the source's environment and host halo to be modest compared to the
