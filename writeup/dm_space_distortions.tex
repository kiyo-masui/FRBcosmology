...
homogeneous. This only affect the radial coordinate such that $\vec x_s = \hat
...
\end{equation}
Averaged over the sky, $\langle \chi_s \rangle = \chi$ and thus `the density should
...
contribution, common to all sources and which may be epoch dependant, which will
...
the source redshift, reweighting the line of sight integral and
...
It can be seen in Figure~\ref{f:terms} that the integral term dominates the
