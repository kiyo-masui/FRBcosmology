...
10 such bursts detected \citep{2012MNRAS.425L..71K,2013Sci...341...53T, 2014ApJ...790..101S, 2014ApJ...792...19B, 2015MNRAS.447..246P,2015ApJ...799L...5R} and total rate of bursts
...
\citep{2004MNRAS.348..999I, 2003ApJ...598L..79I}.
...
\begin{figure}
    ...
    \caption{
        \label{f:n_f}
        \emph{Top:} Comoving density of sources for toy model, as given in
        Equation~\ref{e:n_f}. Normalization is
        such that the survey has a total of $10^4$ FRBs.
        \emph{Bottom:} Coefficient $A(\chi)$ (defined in Equation~\ref{e:A})
        in toy model.
    }
\end{figure}
