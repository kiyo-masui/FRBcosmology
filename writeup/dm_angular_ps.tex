...
\section{2D statistics}
% Need beter section title.
...
\subsection{The dispersion measure angular power-spectrum}

\subsection{estimating the dispersion measure angular power-spectrum}

\subsection{sensitivity estimates}


\section{3D statistics}

3D clustering of FRBs using DM as distance proxy.

Dispersion measure space distortions.

\subsection{First order DM space distortions}

LOS election perturbations cause clusturing in unclustered FRBs.

\subsection{Second order DM space distortions}

LOS election perturbations cause non-stationarity/non-gaussianity in clustered FRBs.
...
% Note about cosmological parameters

\end{comment}

\section{Simplified sensitivity calculation}
